...
# -*- coding: utf-8 -*-
"""
Telegram-бот для приёма .webm (и других аудио), трансформации в txt через Groq Whisper
и сохранения обработанного документа через локальную LLM (localLLMmanager).
Все ключи в config.yaml.
"""
...
from webm_to_txt import transcribe_audio
...
def main():
    ...
    try:
        ...
        print("Ошибка: Токен отклонён. Получите новый у @BotFather и обновите config.yaml", file=sys.stderr)
        sys.exit(1)
